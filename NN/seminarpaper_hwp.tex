...
\subsection{Multisensory integration in MSTd}
...
An ``virtual reality'' motion platform (Figure \ref{fig:apparatus}) is used to control the visual and vestibular stimuli of the study. %TODO
